""" celula o neurona de McCulloch Pitts """
...
class McCullochPitts():
    ...
    def __init__(self, compuerta="AND", epoch=50, n_bits=2):
        ...
        self.epoch=epoch
        if compuerta=="NOT":
            print("Para la compuerta NOT el número de bits es, por defecto, 1")
            self.n_bits=1
    ...
    def _tabla_de_verdad(self,n_bits,compuerta="AND"):
        """ Genera la tabla de verdad para la compuerta que se le pase como
        parámetro y de acuerdo a la cantidad de bits """
        matrix=[]
        aux={}
        tt={}
    ...
    def _fit(self):
        """ intento encontrar los pesos y umbral de la neurona """
        import json
        correct = False
        pesos_sinapticos=[]
        actual_epoch=0
